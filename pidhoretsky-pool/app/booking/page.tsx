    ...
    <div style={{ minHeight: '100vh', background: '#FBFAF6', color: '#3A322A' }}>
            ...
            return (
              <div key={k} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                {i < STEP_ORDER.length - 1 && (
                  <div className="step-conn" style={{ width: 30, height: 1.5, background: done ? '#2E2A24' : '#ECE4D6' }} />
                )}
              </div>
            );
          })}
        ...
        {step === 'tariff' && (
          <div style={{ animation: 'fadeUp .4s ease', maxWidth: 760, margin: '0 auto' }}>
            ...
            <div style={card}>
              ...
              <div className="session-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
      ...
      <style>{`
        ...
        @media (max-width: 560px) {
          ...
          /* Компактніший індикатор кроків, щоб гарно вкладався */
          .steps-row { gap: 4px !important; }
          .steps-row .step-conn { width: 16px !important; }
          .steps-row .step-label { font-size: 12px !important; }
        }
