...
// Парасольки (центри у %)
// Парасольки — декоративні орієнтири. Координати у % від розміру карти.
// Кожна стоїть по центру групи лежаків, яку затіняє.
const UMBRELLAS: [number, number][] = [
  // Далеко ліворуч (біля 51–52 парасольки немає)
  [12, 45],   // центр блоку 48,47,46,45
  [12, 68.5], // центр блоку 44,43,42,41
  [4, 78],    // біля 50,49
  // Ліворуч від басейну
  [30, 40.6], // центр 20,19,18
  [30, 59.6], // центр 17,16,15
  // Праворуч від басейну
  [74, 40.6], // центр 1,2,3
  [74, 59.6], // центр 4,5,6
  // Нижній ряд
  [44, 80], [52, 80], [60, 80],
  ...
  return (
    ...
    >
      ...
      {SPOTS.map((c) => {
        ...
        if (mode === 'block') {
          if (isBooked) {
            bg = 'repeating-linear-gradient(45deg,#E4B4B4,#E4B4B4 4px,#CE9494 4px,#CE9494 8px)'; bd = '#C58585'; col = '#7A3232'; clickable = false;
          } else if (isBlocked) {
